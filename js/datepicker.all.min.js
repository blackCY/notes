(function (g) {
  ...
  var t = {
    ...
    timeReg: function (B) {
      ...
      var o = A.replace(/HH/, "([0-9]{1,2})")
        .replace(/:/g, "(:?)")
        .replace(/(mm|ss)/g, "([0-9]{1,2})");
      return new RegExp("^" + o + "$");
    },
    dayReg: function (C) {
      var B = C.config.format.split(" ")[0];
      var A = new RegExp(C.splitStr, "g");
      var o = B.replace(/YYYY/, "([1-9]{1}[0-9]{3})")
        .replace(A, "(" + C.splitStr + "?)")
        .replace(/(MM|DD)/g, "([0-9]{1,2})");
      return new RegExp("^" + o + "$");
    },
    ...
    fillMonth: function (A, o) {
      ...
      return { month: A, year: o };
    },
    getTimeFormat: function (o) {
      return { year: o.year(), month: o.month() + 1, day: o.date() };
    },
    ...
    judgeTimeRange: function (F, C, o, G) {
      ...
      var D = F.config.min
        ? E.isBefore(t.newDateFixed(F, F.config.min))
        : false;
    ...
    timeVal: function (B, o) {
      ...
      return o === "min"
        ? A.replace(/HH/, "00").replace(/mm/, "00").replace(/ss/, "00")
        : A.replace(/HH/, "23").replace(/mm/, "59").replace(/ss/, "59");
    },
    ...
    getOnlyTimeMinMax: function (F) {
      ...
      var H = F.config.max;
      var L = void 0;
      var o = { hour: L, minute: L, second: L };
      var I = { hour: L, minute: L, second: L };
    ...
    countSecond: function (o) {
      return o.length === 2
        ? (o = Number(o[0]) * 60 + Number(o[1]))
        : o.length === 3
        ? (o = Number(o[0]) * 3600 + Number(o[1]) * 60 + Number(o[2]))
        : false;
    },
  };
  ...
  var k = {
    tableTpl: function (A, B) {
      var o =
        '<table class="' + A + '" style=""><tbody>' + B + "</tbody></table>";
      return o;
    },
    tdTpl: function (o, B) {
      var A =
        '<td class="' + o + '"><div><a class="cell">' + B + "</a></div></td>";
      return A;
    },
    ...
    timeLiTpl: function (A, B) {
      var o =
        '<li class="c-datepicker-time-spinner__item ' + A + '">' + B + "</li>";
      return o;
    },
    timeTpl: function (B, o) {
      var A =
        '<div class="c-datepicker-time-spinner__wrapper c-datepicker-scrollbar"><div class="c-datepicker-scrollbar__wrap ' +
        B +
        '" style="max-height: inherit; margin-bottom: -' +
        y +
        "px; margin-right: -" +
        y +
        'px;"><ul class="c-datepicker-scrollbar__view c-datepicker-time-spinner__list">' +
        o +
        "</ul></div></div>";
      return A;
    },
    timeMainTpl: function (o, B) {
      var A =
        '<div class="c-datepicker-time-panel c-datepicker-popper" style=""><div class="c-datepicker-time-panel__content has-seconds"><div class="c-datepicker-time-spinner has-seconds">' +
        B +
        '</div></div><div class="c-datepicker-time-panel__footer"><button type="button" class="c-datepicker-time-panel__btn min">' +
        o.zero +
        '</button><button type="button" class="c-datepicker-time-panel__btn max">23:59</button><button type="button" class="c-datepicker-time-panel__btn cancel">' +
        o.cancel +
        '</button><button type="button" class="c-datepicker-time-panel__btn confirm">' +
        o.confirm +
        "</button></div></div>";
      return A;
    },
    sideBarButton: function (o, C, A) {
      var B =
        '<button type="button" class="c-datepicker-picker__shortcut" data-value="' +
        o +
        '" data-time="' +
        C +
        '">' +
    ...
    pickerFooterTpl: function (o, B, C) {
      var A =
        '<div class="c-datepicker-picker__footer" style=""><button type="button" class="c-datepicker-button c-datepicker-picker__link-btn c-datepicker-button--text c-datepicker-button--mini ' +
        B +
        '"><span>' +
        C +
        '</span></button><button type="button" class="c-datepicker-button c-datepicker-picker__link-btn confirm c-datepicker-button--default c-datepicker-button--mini is-plain"><span>' +
        o.confirm +
        "</span></button></div>";
      return A;
    },
    ...
    pickerHeaderPrevTpl: function (o, B) {
      var A =
        '<i class="kxiconfont icon-first c-datepicker-picker__icon-btn ' +
        B +
        '__prev-btn year" aria-label="' +
        o.prevYear +
        '"></i><i class="kxiconfont icon-left c-datepicker-picker__icon-btn ' +
        B +
        '__prev-btn month" aria-label="' +
        o.nextMonth +
        '"></i>';
      return A;
    },
    pickerHeaderNextTpl: function (o, B) {
      var A =
        '<i class="kxiconfont icon-right c-datepicker-picker__icon-btn ' +
        B +
        '__next-btn month" aria-label="' +
        o.nextMonth +
        '"></i><i class="kxiconfont icon-last c-datepicker-picker__icon-btn ' +
        B +
        '__next-btn year" aria-label="' +
        o.nextYear +
        '"></i>';
      return A;
    },
    pickerHeaderNextSingleTpl: function (o, B) {
      var A =
        '<i class="kxiconfont icon-last c-datepicker-picker__icon-btn ' +
        B +
        '__next-btn year" aria-label="' +
        o.nextYear +
        '"></i><i class="kxiconfont icon-right c-datepicker-picker__icon-btn ' +
        B +
        '__next-btn month" aria-label="' +
        o.nextMonth +
        '"></i>';
    ...
    pickerTimeHeaderTpl: function (o, B) {
      var A =
        '<span class="' +
        B +
        '__editor-wrap"><div class="c-datepicker-input c-datepicker-input--small"><input type="text" autocomplete="off" placeholder="' +
        o.chooseDay +
        '" class="c-datepicker-input__inner c-datePicker__input-day"></div></span><span class="' +
        B +
        '__editor-wrap"><div class="c-datepicker-input c-datepicker-input--small"><input type="text" autocomplete="off" placeholder="' +
        o.chooseTime +
    ...
    pickerOnlyTimeHeaderTpl: function (B, o) {
      var A =
        '<span class="' +
        B +
        '__editor-wrap"><div class="c-datepicker-only-time-title">' +
        o +
        "</div></span>";
      return A;
    },
    rangePickerMainTpl: function (G, K, H, M, D, o, N) {
      ...
      var B =
        '<div class="c-datepicker-picker c-datepicker-date-range-picker c-datepicker-popper ' +
        K +
        " " +
        H +
        '" x-placement="top-start"><div class="c-datepicker-picker__body-wrapper">' +
        o +
        '<div class="c-datepicker-picker__body"><div class="c-datepicker-date-range-picker__time-header"><div class="c-datepicker-date-range-picker__time-content">' +
        O +
        '</div><span class="kxiconfont icon-right"></span><div class="c-datepicker-date-range-picker__time-content">' +
        O +
        '</div></div><div class="c-datepicker-picker__body-content"><div class="c-datepicker-date-range-picker-panel__wrap is-left">' +
        L +
        '<div class="c-datepicker-picker__content">' +
        N +
        '</div></div><div class="c-datepicker-date-range-picker-panel__wrap is-right">' +
        E +
        '<div class="c-datepicker-picker__content">' +
        N +
        "</div></div></div></div></div>" +
    ...
    pickerFooterOnlyTimeTpl: function (o) {
      var A =
        '<div class="c-datepicker-picker__footer" style=""><button type="button" class="c-datepicker-button c-datepicker-picker__link-btn c-datepicker-button--text c-datepicker-button--mini  c-datepicker-picker__btn-clear"><span>' +
        o.clear +
        '</span></button><button type="button" class="c-datepicker-button c-datepicker-picker__link-btn c-datepicker-button--text c-datepicker-button--mini  c-datepicker-picker__btn-cancel"><span>' +
        o.cancel +
        '</span></button><button type="button" class="c-datepicker-button c-datepicker-picker__link-btn confirm c-datepicker-button--default c-datepicker-button--mini is-plain"><span>' +
        o.confirm +
        "</span></button></div>";
    ...
    rangePickerMainOnlyTimeTpl: function (B, A) {
      ...
      var C =
        '<div class="c-datepicker-picker c-datepicker-date-range-picker c-datepicker-popper ' +
        A +
        '" x-placement="top-start"><div class="c-datepicker-picker__body-wrapper"><div class="c-datepicker-picker__body"><div class="c-datepicker-date-range-picker__time-header"><div class="c-datepicker-date-range-picker__time-content c-datepicker-date-picker__onlyTime-content">' +
        o +
        '</div><div class="c-datepicker-date-range-picker__time-content c-datepicker-date-picker__onlyTime-content">' +
        F +
        "</div></div></div></div>" +
        G +
        E +
    ...
    datePickerMainTpl: function (A) {
      ...
      var B =
        '<div class="c-datepicker-picker c-datepicker-date-picker c-datepicker-popper {{hasTime}} {{hasSidebar}}" x-placement="top-start"><div class="c-datepicker-picker__body-wrapper">{{sidebar}}<div class="c-datepicker-picker__body"><div class="c-datepicker-date-picker__time-header">' +
        o +
        "</div>" +
        G +
        ' <div class="c-datepicker-picker__content">{{table}}</div></div></div>{{footerButton}}' +
        F +
        "</div>";
      return B;
    },
    datePickerMainOnlyTimeTpl: function (o) {
      ...
      var A =
        '<div class="c-datepicker-picker c-datepicker-date-picker c-datepicker-popper ' +
        o +
        '" x-placement="top-start"><div class="c-datepicker-picker__body-wrapper"><div class="c-datepicker-picker__body"><div class="c-datepicker-date-picker__time-header c-datepicker-date-picker__onlyTime-content">' +
        C +
        "</div></div></div>" +
        B +
        "</div>";
  ...
  g.extend(v.prototype, {
    ...
    event: function () {
      if (!this.picker.config.isRange) {
        this.picker.$container.on(
          "click",
          ".c-datepicker-year-table td.available",
          function () {
            ...
            var o = g(this).text();
            A.picker.$container
              .find(".c-datepicker-date-picker__header-year span")
              .text(o);
            if (A.picker.params.isYear) {
              A.picker.$input.val(o);
              A.picker.$container
                .find(".c-datepicker-year-table td.current")
                .removeClass("current");
    ...
    show: function () {
      this.picker.$container
        .find(
          ".c-datepicker-date-table,.c-datepicker-month-table,.c-datepicker-date-picker__header-month"
        )
        .hide();
    ...
    hide: function () {
      ...
      this.picker.$container
        .find(
          ".c-datepicker-date-picker__prev-btn.year,.c-datepicker-date-picker__next-btn.year"
        )
        .removeClass("is-year");
    },
    render: function (B) {
      ...
      this.picker.$container
        .find(
          ".c-datepicker-date-picker__prev-btn.month,.c-datepicker-date-picker__next-btn.month"
        )
        .hide();
      this.picker.$container
        .find(
    ...
    renderHtml: function (G) {
      ...
      var o = A
        ? t.getTimeFormat(moment(t.newDateFixed(this.picker, A))).year
        : false;
      var H = g.fn.datePicker.dates[this.picker.language];
      this.picker.$container
        .find(".c-datepicker-date-picker__header-year span")
        .text(B + H.headerYearLink + "-" + (B + 9));
      for (var E = 0; E < 10; E++) {
        var C = B + E;
  ...
  g.extend(e.prototype, {
    ...
    event: function () {
      if (!this.picker.config.isRange) {
        this.picker.$container.on(
          "click",
          ".c-datepicker-month-table td.available",
          function () {
            if (g(this).hasClass("disabled")) {
              return;
            }
            var C = t.getPicker(g(this), "month");
            var o = C.picker.$container
              .find(".c-datepicker-date-picker__header-year span")
              .text();
            var A =
              C.picker.$container
                .find(".c-datepicker-month-table td")
                .index(g(this)) + 1;
            C.picker.$container
              .find(".c-datepicker-date-picker__header-month span")
              .text(A);
            if (C.picker.params.isMonth) {
              var B = o + C.picker.splitStr + t.fillTime(A);
              C.picker.$input.val(B);
              C.picker.$container
                .find(".c-datepicker-month-table td.current")
                .removeClass("current");
              g(this).addClass("current");
    ...
    show: function () {
      ...
      this.picker.$container
        .find(".c-datepicker-date-table,.c-datepicker-year-table")
        .hide();
    },
    hide: function () {
      this.picker.$container
        ...
        .show();
      this.picker.$container
        .find(".c-datepicker-date-picker__header-month")
        .show();
  ...
  g.extend(b.prototype, {
    ...
    eventSingle: function () {
      this.picker.$container.on(
        "click",
        ".c-datepicker-date-table td.available",
        function (D) {
          D.stopPropagation();
          var E = g(this);
      ...
      function o(G, B) {
        var F = B.text();
        G.picker.$container
          .find(".c-datepicker-date-table td.current")
          .removeClass("current");
        B.addClass("current");
        ...
        if (!E) {
          ...
          A.call(
            G,
            F,
            moment(t.newDateFixed(G.picker, E)),
            moment(t.newDateFixed(G.picker, C))
          );
        }
        if (!G.picker.hasTime) {
          ...
          t.judgeTimeRange(
            G.picker,
            G.picker.$container.find(".c-datePicker__input-day"),
            G.picker.$container.find(".c-datePicker__input-time")
          );
        }
      }
      function A(G, B, F) {
        ...
        var E =
          this.picker.$container
            .find(".c-datepicker-date-picker__header-month span")
            .text() - 1;
        val = B.set({ year: D, month: E, date: G }).format(
          this.picker.config.format.split(" ")[0]
        );
        this.picker.$container.find(".c-datePicker__input-day").val(val);
        var C = F.set({ year: D, month: E, date: G }).format(
    ...
    eventRange: function () {
      ...
      function o(I, D) {
        ...
        var K = E.find(
          ".c-datepicker-date-range-picker__header-year span"
        ).text();
        var J =
          E.find(".c-datepicker-date-range-picker__header-month span").text() -
          1;
        if (I.current >= 2) {
        ...
        if (I.current) {
          ...
          t.judgeTimeRange(
            I.picker,
            I.picker.$container.find(".c-datePicker__input-day").eq(H),
            I.picker.$container.find(".c-datePicker__input-time").eq(H),
            H
          );
        }
      }
      this.picker.$container.on(
        ...
        function () {
          ...
          if (
            moment(t.newDateFixed(E.picker, B)).isAfter(
              t.newDateFixed(E.picker, D)
            )
          ) {
            var H = B;
            B = D;
          ...
          E.addRangeClass(
            moment(t.newDateFixed(E.picker, B)),
            moment(t.newDateFixed(E.picker, D)),
            true
          );
        }
      );
    ...
    show: function () {
      this.picker.$container
        .find(".c-datepicker-year-table,.c-datepicker-month-table")
        .hide();
    ...
    renderSingle: function (F, G, A, D) {
      ...
      if (o.length && !D) {
        ...
        var o = this.picker.$container.find(
          ".c-datepicker-date-picker__header-year span"
        );
        var E = this.picker.$container.find(
          ".c-datepicker-date-picker__header-month span"
        );
        o.text(F);
        E.text(G);
    ...
    addCurrentSingle: function () {
      ...
      var B = this.picker.$container
        .find(".c-datepicker-date-picker__header-year span")
        .text();
      var C = this.picker.$container
        .find(".c-datepicker-date-picker__header-month span")
        .text();
      if (o.year == B && o.month == C) {
        var A = this.picker.$container.find(
          ".c-datepicker-date-table td.available"
        );
    ...
    renderRange: function (I, G, J, M, H) {
      ...
      if (A.length && !H) {
        ...
        E.eq(1 - F)
          ...
          .text(B);
        this.picker.$container
          .find(".c-datepicker-picker__content")
          .eq(F)
          .html(C);
        this.picker.$container
          .find(".c-datepicker-picker__content")
    ...
    prevNextSingle: function (M, H) {
      var F = this.picker.$container.find(
        ".c-datepicker-date-picker__header-year"
      );
      var E = this.picker.$container.find(
        ".c-datepicker-date-picker__header-month"
      );
      ...
      this.picker.$container
        .find(".c-datepicker-month-table,.c-datepicker-year-table")
        .hide();
      if (K.length) {
        K.replaceWith(C);
      } else {
    ...
    prevNextRender: function (L, G) {
      ...
      var D = this.picker.$container.find(
        ".c-datepicker-date-range-picker__header-month"
      );
    ...
    renderHtml: function (K, ac, X) {
      ...
      var E = moment()
        .set({ year: K, month: ac - 1, date: 1 })
        .weekday();
      var F = moment()
        .set({ year: K, month: ac - 1, date: T })
        .weekday();
      ...
      var V = Q
        ? moment(
            t.newDateFixed(
              this.picker,
              this.picker.minJson.year +
                this.picker.splitStr +
                this.picker.minJson.month +
                this.picker.splitStr +
                1
            )
          )
      ...
      var o = S
        ? moment(
            t.newDateFixed(
              this.picker,
              this.picker.maxJson.year +
                this.picker.splitStr +
                this.picker.maxJson.month +
                this.picker.splitStr +
                1
            )
          )
      ...
      var N = moment(
        t.newDateFixed(
          this.picker,
          K + this.picker.splitStr + ac + this.picker.splitStr + 1
        )
      );
    ...
    addRangeClass: function (G, Z, o) {
      ...
      var E =
        ...
        t.getMonthDay(U, K);
      var Y = !(
        M.isBefore(t.newDateFixed(this.picker, B)) ||
        M.isAfter(t.newDateFixed(this.picker, E))
      );
      var L = !(
        aa.isBefore(t.newDateFixed(this.picker, B)) ||
        aa.isAfter(t.newDateFixed(this.picker, E))
      );
      var I;
      var ab =
        M.isBefore(t.newDateFixed(this.picker, B)) &&
        M.isBefore(t.newDateFixed(this.picker, E)) &&
        aa.isBefore(t.newDateFixed(this.picker, B)) &&
        aa.isBefore(t.newDateFixed(this.picker, E));
      var H =
        M.isAfter(t.newDateFixed(this.picker, B)) &&
        M.isAfter(t.newDateFixed(this.picker, E)) &&
        aa.isAfter(t.newDateFixed(this.picker, B)) &&
        aa.isAfter(t.newDateFixed(this.picker, E));
      if (H || ab) {
        return;
      }
      ...
      if (W.is(R)) {
        ...
        if (C.length === 2) {
          ...
          var V = R.parents("tr");
          if (
            W.parents(".c-datepicker-date-range-picker-panel__wrap").is(
              R.parents(".c-datepicker-date-range-picker-panel__wrap")
            )
          ) {
            if (N.is(V)) {
  ...
  g.extend(m.prototype, {
    ...
    event: function () {
      this.picker.$container.on(
        ...
        function () {
          ...
          var B = D.picker.$container
            .find(".c-datePicker__input-time")
            .index(C);
          if (!D.picker.config.isRange) {
            var A = D.picker.$container
              .find(".c-datePicker__input-day")
              .eq(B)
              .val();
      ...
      var o = { timer0: "", timer1: "", timer2: "" };
      this.picker.$container
        .find(".c-datepicker-scrollbar__wrap")
        .scroll(function () {
          var B = t.getPicker(g(this), "time");
          var A = B.picker.$container
            .find(".c-datepicker-scrollbar__wrap")
            .index(g(this));
          clearTimeout(o["timer" + A]);
          o["timer" + A] = setTimeout(
            function () {
    ...
    updateTimePanel: function (B) {
      ...
      var F = this.picker.activeTimeWrap
        .find(".c-datePicker__input-time")
        .val();
    ...
    renderSingle: function (D, o, E, A) {
      ...
      if (!B.length) {
        this.picker.activeTimeWrap
          .find(".c-datepicker-date-picker__editor-wrap")
          .eq(1)
          .append(C);
    ...
    renderRange: function (E, o, F, B) {
      ...
      if (!C.length) {
        ...
        A.eq(0)
          .find(".c-datepicker-date-range-picker__editor-wrap")
          .eq(1)
          .append(D);
        A.eq(1)
          .find(".c-datepicker-date-range-picker__editor-wrap")
  ...
  g.extend(h.prototype, {
    event: function () {
      ...
      this.picker.$container
        ...
        .scroll(function () {
          ...
          var E = g(this).parents(
            ".c-datepicker-date-picker__onlyTime-content"
          );
          var D = F.picker.$container
            .find(".c-datepicker-date-picker__onlyTime-content")
            .index(E);
    ...
    updateRange: function (C, B) {
      ...
      var D = function (F) {
        return { hour: F[0], minute: F[1], second: F[2] };
      };
    ...
    updateTimeInput: function (C, B) {
      if (this.picker.config.isRange) {
        ...
        var o = this.picker.$container
          .find(".c-datepicker-time-panel")
          .index(A);
    ...
    render: function (B, o, C, A) {
      if (this.picker.config.isRange) {
        ...
        this.picker.$container
          .find(
            ".c-datepicker-time-panel__btn.cancel,.c-datepicker-time-panel__btn.confirm"
          )
          .remove();
      } else {
        this.renderSingle(B, o, C, A);
  ...
  var p = {
    ...
    initParams: function (o) {
      ...
      o.minJson = o.config.min
        ? t.getTimeFormat(moment(t.newDateFixed(o, o.config.min)))
        : false;
      o.maxJson = o.config.max
        ? t.getTimeFormat(moment(t.newDateFixed(o, o.config.max)))
        : false;
    },
  ...
  g.extend(q.prototype, {
    ...
    initShow: function () {
      ...
      if (
        ...
        this.params.format[4] ||
        this.params.format[5]
      ) {
        H = "has-time";
      }
      ...
      var D = g(
        C.replace(/{{table}}/g, I)
          .replace(/{{year}}/g, G.year)
          .replace(/{{month}}/g, G.month)
          .replace("{{sidebar}}", o)
          .replace("{{hasTime}}", H)
          .replace("{{hasSidebar}}", F)
      );
      g("body").append(D);
      this.$container = D;
    ...
    event: function () {
      ...
      this.$container.on(
        "click",
        ".c-datepicker-date-picker__next-btn.month",
        function (A) {
          A.stopPropagation();
      ...
      this.$container.on(
        "click",
        ".c-datepicker-date-picker__prev-btn.month",
        function (A) {
          A.stopPropagation();
          var B = t.getPicker(g(this));
          o(B, "prev", "month");
      ...
      this.$container.on(
        "click",
        ".c-datepicker-date-picker__next-btn.year",
        function (C) {
          C.stopPropagation();
          ...
          if (g(this).hasClass("is-year")) {
            var B =
              Number(
                D.$container
                  .find(".c-datepicker-year-table td.available")
                  .first()
                  .find(".cell")
                  .text()
              ) + 10;
      ...
      this.$container.on(
        "click",
        ".c-datepicker-date-picker__prev-btn.year",
        function (C) {
          C.stopPropagation();
          var D = t.getPicker(g(this));
          if (g(this).hasClass("is-year")) {
      ...
      this.$container.on(
        "click",
        ".c-datepicker-picker__link-btn.confirm",
        function () {
          var B = t.getPicker(g(this));
          if (!B.$input.val()) {
            var A = r(B).value;
    ...
    eventHasTime: function () {
      ...
      this.$container.on("blur", ".c-datePicker__input-day", function (o) {
        ...
        t.judgeTimeRange(
          A,
          g(this),
          A.$container.find(".c-datePicker__input-time")
        );
      });
      this.$container.on("blur", ".c-datePicker__input-time", function (o) {
        ...
        t.judgeTimeRange(
          A,
          A.$container.find(".c-datePicker__input-day"),
          g(this)
        );
      });
      this.$container.on("focus", ".c-datePicker__input-time", function (A) {
        ...
        C.activeTimeWrap = g(this).parents(
  ...
  g.extend(j.prototype, {
    ...
    initShow: function () {
      ...
      if (!this.hasTime) {
        this.$container
          .find(".c-datepicker-date-range-picker__time-header")
          .hide();
      }
    ...
    event: function () {
      ...
      this.$container.on(
        "click",
        ".c-datepicker-date-range-picker__next-btn.month",
        function () {
          var A = t.getPicker(g(this));
          o(A, "next", "month");
        }
      ...
      this.$container.on(
        "click",
        ".c-datepicker-date-range-picker__prev-btn.month",
        function () {
          var A = t.getPicker(g(this));
          o(A, "prev", "month");
        }
      ...
      this.$container.on(
        "click",
        ".c-datepicker-date-range-picker__next-btn.year",
        function () {
          var A = t.getPicker(g(this));
          o(A, "next", "year");
        }
      ...
      this.$container.on(
        "click",
        ".c-datepicker-date-range-picker__prev-btn.year",
        function () {
          var A = t.getPicker(g(this));
          o(A, "prev", "year");
        }
    ...
    eventHasTime: function () {
      ...
      this.$container.on("focus", ".c-datePicker__input-time", function (A) {
        ...
        B.activeTimeWrap = g(this).parents(
          ".c-datepicker-date-range-picker__time-content"
        );
        B.showTimeSelect();
      ...
      this.$container.on(
        "focus",
        ".c-datePicker__input-day,.c-datePicker__input-time",
        function () {
          var B = t.getPicker(g(this));
      ...
      this.$container.on("blur", ".c-datePicker__input-day", function (A) {
        ...
        t.judgeTimeRange(
          B,
          g(this),
          B.$container.find(".c-datePicker__input-time").eq(o),
          o
        );
      });
      this.$container.on("blur", ".c-datePicker__input-time", function (A) {
        ...
        t.judgeTimeRange(
          B,
          B.$container.find(".c-datePicker__input-day").eq(o),
          g(this),
          o
        );
      });
    ...
    clear: function () {
      ...
      this.$inputEnd.val("");
      this.$container
        .find(".c-datePicker__input-day,.c-datePicker__input-time")
        .val("");
  ...
  g.extend(w.prototype, {
    ...
    initShow: function () {
      ...
      var B = g.fn.datePicker.dates[this.language];
      var o = this.config.isRange
        ? k.rangePickerMainOnlyTimeTpl(B, C)
        : k.datePickerMainOnlyTimeTpl(C);
  ...
  g.extend(u.prototype, {
        ...
        if (F.pickerObject.hasTime) {
          ...
          if (F.onlyTime) {
            if (!B || !E) {
              ...
              if (E) {
                B = E[5]
                  ? E[1] + ":" + t.fillTime(E[3]) + ":" + t.fillTime(E[5])
                  : E[1] + ":" + t.fillTime(E[3]);
              }
              this.value = B;
            }
          ...
          if (F.pickerObject.params.isMonth) {
            var D = moment(
              t.newDateFixed(F.pickerObject, J + F.pickerObject.splitStr + "01")
            );
    ...
    hide: function (o) {
      this.pickerObject.$container
        .find(".td.available")
        .removeClass("current in-range");
    ...
    betweenHandle: function () {
      ...
      if (H.between === "month") {
        if (A.year !== B.year || A.month !== B.month) {
          var C = D.set({ year: B.year, month: B.month - 1, date: 1 }).format(
            H.format
          );
      ...
      if (H.between === "year") {
        if (A.year !== B.year) {
          var C = D.set({ year: B.year, month: 0, date: 1 }).format(H.format);
          this.pickerObject.$inputBegin.val(C);
        }
        return;
      }
  ...
  function i(B) {
    ...
    B.pickerObject.$container.css({ top: A.top + o, left: A.left });
  }
  function n(C, A) {
    var B = A.val();
    ...
    if (!B || !o) {
      ...
      if (o) {
        B = C.config.format
          .split(" ")[1]
          .replace(/HH/, o[1])
          .replace(/mm/, t.fillTime(o[3]))
          .replace(/ss/, t.fillTime(o[5]));
        A.val(B);
        if (!C.config.isRange) {
          A.trigger("keyup");
        }
  ...
  function a(D, B) {
    ...
    if (!o || !A) {
      ...
      if (A) {
        A = t.fixedFill(A);
        o =
          A[1] + D.splitStr + t.fillTime(A[3]) + D.splitStr + t.fillTime(A[5]);
        B.val(o);
        if (!D.config.isRange) {
          B.trigger("keyup");
        }
